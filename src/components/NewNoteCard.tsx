...
type TNewNoteCardProps = {
  onNoteCreated: (content: string) => void;
};

let speechRecognition: SpeechRecognition | null;

const NewNoteCard = ({ onNoteCreated }: TNewNoteCardProps) => {
          ...
          <form className="flex-1 flex flex-col">
            ...
            {isRecording ? (
              ...
              <button
                ...
                className="w-full bg-lime-400 py-4 text-center text-sm text-lime-950 outline-none font-medium 
          hover:bg-lime-500"
              >
                Salvar nota
              </button>
